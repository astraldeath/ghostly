...
Limits: 1 MB file, 100 lists, 1000 total rules, 500 exclusions, 80 characters per list name, 500 characters per rule and a whole-number retention age from 0 to 36500 days. Invalid input is rejected with an error rather than silently dropping protections.
